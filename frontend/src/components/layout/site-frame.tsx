 ...
 * are not card chrome. Overlay is `absolute` so it stretches with the
 * scroller, not the document. `pulse` paints a traveling tick on the existing
 * right line; it does not add a second rule.
 *
