...
| `/company/[id]`                 | Resumen de la empresa: score del cierre sobre la regla de bandas, variación, confianza, tensión a 6 meses y días de caja; alerta de señal; trayectoria con previsión +1..+6 m y banda p10-p90; «Qué hacer ahora» (hasta tres acciones escritas por el modelo).                                                                                                                                                                                                                                                   |
| `/company/[id]/diagnosis`       | Diagnóstico: mosaico de las 11 variables por pilar (ancho = peso del pilar, alto = peso de la variable, color sólo en el punto) con la tira de detalle de la variable elegida, y la evolución de los cuatro pilares.                                                                                                                                                                                                                                                                                             |
