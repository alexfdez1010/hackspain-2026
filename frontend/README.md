...
| `/company/[id]`                 | Resumen de la empresa: score del cierre sobre la regla de bandas, variación, confianza y días de caja; alerta de señal; trayectoria con previsión +1..+6 m y banda p10-p90; «Qué hacer ahora» (hasta tres acciones escritas por el modelo).                                                                                                                                                                                                                                                                      |
