...
export const VARS = [
  { k:"tramo90", i:8,  n:"Tramo +90 días",                 pillar:"cobro", weight:12, ago:71.8, valor:"10,0 % de la cartera" },
  { k:"contra",  i:12, n:"Exposición a contrapartes",       pillar:"cobro", weight:10, ago:63.0, valor:"0,00 pts de salud de clientes" },
  { k:"topcli",  i:9,  n:"Caída del cliente top",           pillar:"cobro", weight:8,  ago:34.0, valor:"−37,0 % vs trimestre anterior" },
  { k:"dso",     i:7,  n:"DSO real",                        pillar:"cobro", weight:6,  ago:33.6, valor:"31,9 días" },
  { k:"minintra",i:2,  n:"Mínimo intramensual de caja",     pillar:"liq",   weight:14, ago:30.4, valor:"0,11 × salidas mensuales" },
  { k:"diascaja",i:1,  n:"Días de caja",                    pillar:"liq",   weight:12, ago:39.0, valor:"14,0 días" },
  { k:"util",    i:3,  n:"Utilización de líneas",           pillar:"deuda", weight:12, ago:null, valor:"sin datos" },
  { k:"venc6",   i:10, n:"Vencimientos 6 m sobre caja",     pillar:"deuda", weight:8,  ago:34.0, valor:"0,00 × caja" },
  { k:"acel",    i:4,  n:"Aceleración de utilización",      pillar:"deuda", weight:6,  ago:null, valor:"sin datos" },
  { k:"dpo",     i:5,  n:"DPO real y su variación",         pillar:"pago",  weight:6,  ago:68.7, valor:"24,4 días" },
  { k:"plazo",   i:6,  n:"Plazo concedido por proveedores", pillar:"pago",  weight:6,  ago:33.5, valor:"16,8 días" }
];
...
export const RISK = { tension6m:28, portfolio:22, euribor12:"2,10 %" };
export const CATALOG = 7;
export const FIT_MIN = 40;
export const PRODUCTS = [
  { n:"Línea de crédito", cat:"Circulante", amount:"45.000 €", term:"12 meses", rate:"9,17 %", spread:"+707 pb", fit:85,
    desc:"Dispones solo cuando la caja lo necesita; pagas intereses únicamente por lo dispuesto." },
  { n:"Confirming de proveedores", cat:"Pagos", amount:"90.000 €", term:"12 meses", rate:"6,75 %", spread:"+465 pb", fit:65,
    desc:"El banco paga a tus proveedores en la fecha pactada y tú liquidas más tarde." },
  { n:"Anticipo de facturas", cat:"Cobros", amount:"130.000 €", term:"12 meses", rate:"5,65 %", spread:"+355 pb", fit:50,
...
export const REJECTED = [
  ...
  { n:"Reestructuración de vencimientos", why:"Los vencimientos de seis meses son 0,00 veces tu caja: tu deuda actual es asumible." },
